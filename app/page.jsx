...
export default function Home() {
  ...
  const mySkillsScrollHandler = () => {
    const mySkills = document.getElementById("my-skills");

    setTimeout(() => {
      if (mySkills) {
        const sectionTopOffset = mySkills.offsetTop;
  ...
  const ContactScrollHandler = () => {
    ...
    setTimeout(() => {
      if (contact) {
        const sectionTopOffset = contact.offsetTop;
  ...
  return (
    <div className="selection:bg-sky-500 flex flex-col" >

      <Header languageChangeHandler={languageChangeHandler}
        defaultLanguage={defaultLanguage}
        workSampleScrollHandler={workSampleScrollHandler}
        mySkillsScrollHandler={mySkillsScrollHandler}
        ContactScrollHandler={ContactScrollHandler}
      />



      <Biography defaultLanguage={defaultLanguage} />
      <MyWorks defaultLanguage={defaultLanguage} />
      <SampleWork defaultLanguage={defaultLanguage} />
      <MySkills defaultLanguage={defaultLanguage} />
...
//         setBoxOpen((prevBoxOpen) => !prevBoxOpen);
//     };
...
//                         <button onClick={toggleBoxHandler} className="relative mt-4">
//                             {!boxOpen ? (
//                                 <svg
//                                     className="text-gray-600 hover:bg-gray-100 rounded-[50%] h-12 w-12 p-1"
//                                     xmlns="http://www.w3.org/2000/svg"
//                                     width="32"
//                                     height="32"
//                                     fill="currentColor"
...
//                                     </ul>
//                                 </div>
//                                 <div onClick={closeBoxHandler} className="absolute w-full h-full mt-[90px]">
