...
const Biography = ({ defaultLanguage }) => {
    ...
    return (
        <div className="max-w-12/12 h-[640px] flex mb-[50px] max-[1140px]:flex-col max-[1140px]:items-center max-[1140px]:mt-[50px]  max-[1140px]:mb-[400px]">
            ...
            <div className='w-6/12 max-[1140px]:w-[340px] max-w-fit h-full flex items-center '>
                <div className={`flex flex-col w-[570px] mr-5 max-[1140px]:w-[400px] max-[1140px]:mr-0 max-[1140px]:mt-5 max-[1140px]:items-center ${!defaultLanguage ? 'items-end max-[1140px]:items-center' : 'max-[1140px]:items-center'}`}>
                    <h1 className="font-bold mb-2">{defaultLanguage ? 'امیرمحمد هستم' : 'I am Amirmohammad'} </h1>
                    <h2 className="font-bold max-[1140px]:text-[20px] mb-8">{defaultLanguage ? 'توسعه دهنده فرانت اند وبسایت' : 'a Front-end Developer'}</h2>
                    <p className={'leading-relaxed text-justify tracking-normal text-[16px] max-[500px]:px-2' + (!defaultLanguage ? ' !text-left' : '')}>                        {defaultLanguage ? 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان داشت که تمام و دشواری موجود در ارائه راهکارها،و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.' :
